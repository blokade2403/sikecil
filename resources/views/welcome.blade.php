                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-6">
                                        <div class="card-bx bg-blue">
                                            <img class="pattern-img" src="images/pattern/pattern6.png"
                                                alt="">
                                            ...
                                            <a class="change-btn" href="javascript:void(0);"><i
                                                    class="fa fa-caret-up up-ico"></i>Change<span
                                                    class="reload-icon"><i
                                        ...
                                        <div class="row  mt-xl-0 mt-4">
                                            <div class="col-md-6">
                                                ...
                                                <ul class="card-list mt-4">
                                                    <li><span class="bg-blue circle"></span>Account<span>20%</span>
                                                    </li>
                                                    ...
                                                    <li><span class="bg-light circle"></span>Others<span>15%</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-md-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="format-slider">
                                    <input class="form-control amount-input" title="Formatted number"
                                        id="input-format">
                                ...
                                <div class="d-sm-flex d-block">
                                    ...
                                    <div class="form-check toggle-switch text-end form-switch me-auto">
                                        ...
                                        <label class="form-check-label"
                                            for="flexSwitchCheckDefault1">Analytics</label>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-responsive-md card-table transactions-table">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <svg class="bgl-success tr-icon" width="63"
                                                            height="63" viewBox="0 0 63 63" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <g>
                                                                <path
                                                    ...
                                                    <td>
                                                        <h6 class="fs-16 font-w600 mb-0"><a
                                                                href="javascript:void(0);" class="text-black">XYZ
                                                                Store ID</a></h6>
                                                ...
                                                <tr>
                                                    <td>
                                                        <svg class="bgl-danger tr-icon" width="63"
                                                            height="63" viewBox="0 0 63 63" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <g>
                                                                <path
                                                    ...
                                                    <td>
                                                        <h6 class="fs-16 font-w600 mb-0"><a
                                                                href="javascript:void(0);" class="text-black">Chef
                                                                Renata</a></h6>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="fs-16 font-w600 mb-0"><a
                                                                href="javascript:void(0);" class="text-black">Cindy
                                                                Alexandro</a></h6>
                                                        <span class="fs-14">Transfer</span>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="me-auto">
                                                ...
                                                <p class="fs-16 mb-0 mt-2"><span class="text-danger">-0,8%
