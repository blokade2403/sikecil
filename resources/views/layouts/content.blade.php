                        ...
                        <div class="card-body pt-0 count-student">
                            <div class="school-wrapper">
                                <div class="school-header">
                                    ...
                                    <div class="d-flex gap-1 align-items-center flex-wrap pt-xxl-0 pt-2">
                                        <i class="icon-arrow-up f-light"></i><span class="f-w-500 f-light">+6.7%</span>
                                    </div>
                                </div>
                                <div class="school-body">
                                                ...
                                                <div class="d-flex">
                                                    <div
                                                        ...
                                                        <input class="from-check-input" id="checkbox-task-1"
                                                            ...
                                                            class="form-check-label" for="checkbox-task-1">
                                                        </label>
                                                    </div>
                                                    <div
                            ...
                            <div class="knowledge-wrapper">
                                ...
                                <div class="knowledgebase-wrapper">
                                    <img class="knowledge-img img-fluid w-100"
                                        src="../assets/images/dashboard-7/knowledge-base.png" alt="knowledge-base" />
                                </div>
                            </div>
                        </div>
                    </div>
