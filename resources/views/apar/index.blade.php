                                                            ...
                                                            @foreach ($apars as $apar)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a
                                                                            href="{{ route('apar.show', $apar->id) }}">Detail</a>
                                                                    </td>
                                                                </tr>
                                                                </tr>
                                                                @include('apar.modal_detail')
                                                            @endforeach
                                                        </tbody>
                                                    </table>
                                                </div>
...
{{--
<a href="{{ route('apar.create') }}">Tambah APAR</a>
...
<table>
    ...
    @foreach ($apars as $apar)
        <tr>
            ...
            <td>{{ $apar->kondisi }}</td>
            <td>
                <a href="{{ route('apar.show', $apar->id) }}">Detail</a>
            </td>
        </tr>
    @endforeach
</table> --}}
