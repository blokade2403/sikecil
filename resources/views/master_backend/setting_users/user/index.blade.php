            ...
            <div class="col-xxl-12 recent-xl-77 col-xl-9 box-col-9">
                <div class="row">
                    <div class="col-12">
                        ...
                        @include('master_backend.setting_users.user.modal_add')
                    </div>
                    <div class="col-12">
                                                        ...
                                                        <tbody>
                                                            @foreach ($users as $c)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $c->nama }} </td>
                                                                    <td>{{ $c->email }} </td>
                                                                    <td>{{ $c->position->nama_jabatan ?? '-' }} </td>
                                                                    <td>{{ $c->unit->nama_unit ?? '-' }} </td>
                                                                    <td>
                                                                        @foreach ($c->roles as $role)
                                                                            <span
                                                                                class="badge bg-primary">{{ $role->nama_role }}</span>
                                                                        @endforeach
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <ul class="action">
                                                                            ...
                                                                            <li class="delete">
                                                                                <form
                                                                                    action="{{ route('users.destroy', $c->id) }}"
                                                                                    method="POST"
