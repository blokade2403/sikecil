            ...
            <div class="col-xxl-12 recent-xl-77 col-xl-9 box-col-9">
                <div class="row">
                    <div class="col-12">
                        ...
                        @include('master_backend.setting_users.employee.modal_add')
                    </div>
                    <div class="col-12">
                                                        ...
                                                        <tbody>
                                                            @foreach ($employees as $c)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $c->nip }} </td>
                                                                    <td>{{ $c->nama }} </td>
                                                                    <td>{{ $c->tanggal_lahir->format('d-m-Y') }}</td>
                                                                    <td>{{ \Carbon\Carbon::parse($c->tanggal_lahir)->age }}
                                                                        Tahun</td>
                                                                    </td>
